...
export default function DashboardNative({
  ...
  return (
    <ScrollView className="flex-1 bg-pagebg px-5 py-6">
      {/* ── Stats Grid ── */}
      <View className="flex-row flex-wrap -mx-2 mb-6">
        ...
        <View className="w-1/2 px-2">
          <NativeCard className="h-[120px] justify-between border-green-100 bg-green-50/20">
            <View className="flex-row justify-between">
        ...
        <View className="w-1/2 px-2">
          <NativeCard className="h-[120px] justify-between border-orange-100 bg-orange-50/20">
            <View className="flex-row justify-between">
